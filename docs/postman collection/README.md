...
- **[VERIFICATION_TESTING_GUIDE.md](./VERIFICATION_TESTING_GUIDE.md)** - Руководство по тестированию верификации email (RU)
- **[VERIFICATION_QUICK_START.md](./VERIFICATION_QUICK_START.md)** - Быстрый старт по верификации email (EN)
...
2. � **Email Verification Flow** - Полный цикл верификации email (~8 сек)
3. �👤 **Complete User Journey** - Регистрация → Верификация → Логин → Профиль (~7 сек)
4. 📦 **Order Lifecycle** - Полный цикл заказа (~10 сек)
5. 🏗️ **Contractor Setup** - Настройка профиля подрядчика (~6 сек)
6. 💎 **Subscription Management** - Управление подписками (~6 сек)
7. ⭐ **Review System Flow** - Создание и ответ на отзывы (~6 сек)
8. ⚖️ **Dispute Resolution** - Разрешение споров (~6 сек)
9. 💬 **Chat Flow** - Отправка и получение сообщений (~5 сек)
10. 🔔 **Notifications Flow** - Система уведомлений (~7 сек)
11. 🔐 **Security & Error Handling** - Тестирование безопасности (~5 сек)
